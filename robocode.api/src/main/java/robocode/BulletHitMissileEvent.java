 ...
 */
public final class BulletHitMissileEvent extends Event {
     ...
     * @param hitMissile the bullet that was hit by your bullet
     */
    public BulletHitMissileEvent(Bullet bullet, Missile hitMissile) {
        super();
        this.bullet = bullet;
    ...
    final void dispatch(IBasicRobot robot, IRobotStatics statics, Graphics2D graphics) {
        ...
        if (listener != null) {
            listener.onBulletHitMissile(this);
        }
    }
    ...
    byte getSerializationType() {
        return RbSerializer.BulletHitMissileEvent_TYPE;
    }
    ...
    private static class SerializableHelper implements ISerializableHelper {
        public int sizeOf(RbSerializer serializer, Object object) {
            BulletHitMissileEvent obj = (BulletHitMissileEvent) object;

            return RbSerializer.SIZEOF_TYPEINFO + RbSerializer.SIZEOF_INT
                    + serializer.sizeOf(RbSerializer.Bullet_TYPE, obj.hitMissile);
        }
        ...
        public void serialize(RbSerializer serializer, ByteBuffer buffer, Object object) {
            ...
            serializer.serialize(buffer, RbSerializer.Missile_TYPE, obj.hitMissile);
        }
        ...
        public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
            ...
            return new BulletHitMissileEvent(bullet, hitMissile);
        }
    }
}
